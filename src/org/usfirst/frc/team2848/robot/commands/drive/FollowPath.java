...
import org.usfirst.frc.team2848.robot.util.Path;
import org.usfirst.frc.team2848.robot.util.TextFileDeserializer;
import org.usfirst.frc.team2848.robot.util.Trajectory;
...
public class FollowPath extends Command {
    ...
    public FollowPath(String namePath, boolean backwards, boolean reverseLeftRight,double gyroMultiplier, double degrees) {
    ...
    protected void initialize() {
    	...
    	m_startEncoderLeft = Robot.drivetrain.getEncoderLeft();
    	m_startEncoderRight = Robot.drivetrain.getEncoderRight();
    ...
    protected void execute() {
    	...
    	/*else if(m_backwards && m_finalPositionRight >= Robot.getDriveBaseSimple().getEncoderRight() && m_finalPositionLeft >= Robot.getDriveBaseSimple().getEncoderLeft()){
    	...
    	else
        	{
        		...
        		double currentAngle = Robot.drivetrain.gyro.getYaw();
        		int realLeftEncoder = Robot.drivetrain.getEncoderLeft();
        		int realRightEncoder = Robot.drivetrain.getEncoderRight();
        		...
        		Robot.drivetrain.setLeftMotor(leftMotorLevel);
        		Robot.drivetrain.setRightMotor(rightMotorLevel);
